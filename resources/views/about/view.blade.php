...
@section('content')
    ...
    <div class="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]
                -mt-4 md:-mt-6 h-[350px] md:h-[450px]
                overflow-hidden mb-12 shadow-md">
            ...
            <div>
                ...
                <div class="text-center">
                    <button
                        ...
                        class="px-6 py-2.5 bg-cyan-600 text-white
                               font-medium rounded-md
                               hover:bg-cyan-700 transition duration-300 shadow-md">
