...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const activeCard = document.querySelector('.ekskul-card.is-active');

    if (activeCard) {
        const initialFlip =
            activeCard.dataset.flipBackground === 'true';
        ...
        title.textContent = activeCard.dataset.nama;
        description.textContent = activeCard.dataset.deskripsi;
    }
    ...
    cards.forEach((card) => {
        ...
        card.addEventListener('click', (event) => {
            ...
            const flipBackground =
                card.dataset.flipBackground === 'true';

            // Jangan melakukan apa-apa
            // kalau card sudah aktif
            ...
            cards.forEach((item) => {
                ...
                const overlay =
                    item.querySelector('.ekskul-overlay');
            ...
            const activeOverlay =
                card.querySelector('.ekskul-overlay');
            ...
            backgroundAnimation.classList.add(
                'ekskul-bg-animation'
            );
